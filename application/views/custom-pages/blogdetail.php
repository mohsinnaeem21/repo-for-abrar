		...
		<div class="container">	
			<div class="row">	
				<div class="col-sm-12 col-md-12 col-lg-12">
					<div class="col-sm-12 col-md-12 col-lg-12">
					<img type='image' src="<?php echo $usersData['image'] ?> " id="blog_image" style= "width:150px; height:100px;"></img>
					</div>
					<div class="col-sm-12 col-md-12 col-lg-12"> 
					<br>
					<h3> <br> <?php echo $usersData['title'] ?> <br> </h3>
					<br>
					</div>
					<div class="col-sm-12 col-md-12 col-lg-12">
					<p>Description: <?php echo $usersData['content'] ?> <br></p>					
					<a href="<?php echo site_url('Websitecontroller/show_author_blog/').$usersData['author_name'] ?>"> Written by :<?php echo $usersData['author_name']?> </a>
					</div>
				</div>
			</div>
		</div>
